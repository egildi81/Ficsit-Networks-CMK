...
"""
train_server_simple_1.0.4-a.py : serveur web (sans bot Discord) pour Train Monitor — Satisfactory
- Flask  : dashboard web sur le port 8081
- Pas de dépendance Discord ; basé sur train_server.py 1.0.4

Lancer : python train_server_simple_1.0.4-a.py
Config  : renseigner config.py (optionnel pour SITE_TITLE)
"""
...
def receive_push():
    ...
    global _cache, _cache_updated_at, _trips, _stats, _stockage, _log_ring, _log_total_ever, _dispatch_status
...
def run_flask():
    """Lance Flask dans le thread principal (pas de bot Discord dans cette variante)."""
...
if __name__ == "__main__":
    print("Serveur (mode simple) démarré — en attente de données LOGGER via POST /api/push ...")
