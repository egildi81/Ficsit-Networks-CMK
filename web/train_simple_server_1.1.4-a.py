...
"""
train_simple_server_1.1.4-a.py : serveur web (sans bot Discord) pour Train Monitor — Satisfactory
- Flask : dashboard web sur le port 8081
- Pas de dépendance Discord ; basé sur train_server.py 1.1.4

Lancer : python train_simple_server_1.1.4-a.py
Config  : optionnel — config.py peut définir SITE_TITLE
"""
...
# Config facultative (SITE_TITLE). Fallback si config.py est absent.
try:
